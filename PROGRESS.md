...
| T5 — Group-aware train/val/test split | 🔍 Proposal awaiting owner approval | 2026-07-07; `src/dataset_tools/split_dataset.py`, 16 tests (TDD red→green, suite **76 passing**). Dry-run proposal delivered (seed 42): 19 prefix families, train 115/val 25/test 24 images (70.1/15.2/14.6%). ⚠ Prefix heuristic may under-group manufacturer templates (IAUA vs IAUAN vs IAUC; AUIR* subfamilies; BSC vs BSZ) — owner to decide family-merge rules before the split is frozen. NO split files written. |
